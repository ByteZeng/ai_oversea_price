...
LEFT JOIN domestic_warehouse_clear.yibai_site_table_amazon st
ON yac.site = st.site
LEFT JOIN (
    SELECT
...
SELECT accountid as account_id, asin, site,toFloat64(replaceAll(if(total_stars='','0.0',total_stars),'5つ星のうち','')) as  total_stars, crawl_time
